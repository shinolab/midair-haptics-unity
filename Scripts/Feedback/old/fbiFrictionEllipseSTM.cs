...
public class fbiFrictionEllipseSTM : fbiEllipseSTM {
    ...
    void DetermineFreqSTM(HaptObject obj, ref float freq, ref int step)
    {
    ...
    void DetermineRotFreqSTM(HaptObject obj, ref float freq, ref int step)
    {
